<main class="show">
<div class="textregi">
<p class="regi3">Juntos aprendemos mais </p>
    <p>Bem Vindo </p>

    <img src="./img/download (6).png" alt="mascoote" class="mascote3">

    <p class="textregi2">Obrigado por fazer parte <br>dessa experiência de aprendizado</p>


</div>
<img src="./img/denvtop.webp" alt="denvtop" class="denvtop">
<div class="regi">
